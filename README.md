...
The only prerequisite is Bazel, via
[bazelisk](https://github.com/bazelbuild/bazelisk) -- see [INSTALL.md](INSTALL.md)
for building it from source if Homebrew isn't an option. Everything else
(the Python 3.12 toolchain, pip dependencies, and uv itself) is fetched
